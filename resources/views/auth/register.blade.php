                ...
                <div class="custom-form-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            ...
                            <div class="input-container">
                                <input id="password-confirm" type="password" class="custom-form-input" name="password_confirmation" required autocomplete="new-password" placeholder="Confirma tu contraseña...">
                            </div>
                        </div>
